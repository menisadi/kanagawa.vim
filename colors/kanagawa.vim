" ============================================================================
" Kanagawa Colorscheme for Vim
" Inspired by kanagawa.nvim (wave variant)
...
" ----------------------------------------------------------------------------
" Palette (Wave variant from the official Kanagawa palette)
" ----------------------------------------------------------------------------
let s:palette = {}
...
" ----------------------------------------------------------------------------
" Helper function to set highlight groups easily
" ----------------------------------------------------------------------------
...
" ----------------------------------------------------------------------------
" Diagnostics (If you're using built-in LSP or ALE, etc.)
" ----------------------------------------------------------------------------
...
" For LSP (if you use built-in diagnostics):
